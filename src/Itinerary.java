...
public class Itinerary {
	...
	/**
	 * this getter method concatenate the flight info, with | separator, into one
	 * row of String as one complete itinerary
	 * <p>
	...
	public String getItinerary() {
		...
		itinerary = rank + ("|") + price + ("|") + provider + ("|") + flyOut.getFlights() + ("|") + flyIn.getFlights()
				+ ("|") + link + ("|") + details;
		return itinerary;
	}
