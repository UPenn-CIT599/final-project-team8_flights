...
/**
 * Class to test AirportCode class by checking if the AirportReader and Airport classes reads 
 * airports.dat.txt database correctly and if AirportCode searchAirport method outputs expected 
 * airport code.
 * <p>
 ...
 * they are not compatible with JUnit4.
 */
...
//  @BeforeAll
  ...
  /**
   * Test case 1 checks if AirportReader and Airport classes start and run correctly by reading
   * number of airports 
   */
  @Test
  ...
  public void AirportReaderRow1AirportNameTest() {
    ...
    assertEquals("Goroka Airport", airports.get(0).getAirportName() , 
        "Expected airport name is : Goroka Airport");
  }
  ...
  public void AirportReaderRow1AirportCodeTest() {
    ...
    assertEquals("GKA", airports.get(0).getIATACode() , 
        "Expected airport code is : GKA");
  }
  ...
  public void AirportCodeDeptStockholmTest1() {
    ...
    assertEquals("BMA", newAirport.getDeptAirportCode(), 
        "Expected airport code is : BMA");
  }
  ...
  public void AirportCodeDeptStockholmTest2() {
    ...
    System.out.println("departure airport code is " + newAirport.getDeptAirportCode());
    assertEquals("ARN", newAirport.getDeptAirportCode(), 
        "Expected airport code is : ARN");
  }
  ...
  public void AirportCodeDeptStockholmTest3() {
    ...
    System.out.println("departure airport code is " + newAirport.getDeptAirportCode());
    assertEquals("Melitopol Air Base", newAirport.getDeptAirportCode(), 
        "Expected airport code is : Not Found");
  }
  ...
  public void AirportCodeDeptStockholmTest4() {
    ...
    assertEquals(true, newAirport.isValidDeptAirport(), 
  ...
  public void AirportCodeDeptStockholmTest5() {
    ...
    System.out.println("departure airport code is " + newAirport.getDeptAirportCode());
    System.out.println("is departure airport valid? " + newAirport.isValidDeptAirport());
    assertEquals(false, newAirport.isValidDeptAirport(), 
  ...
  public void AirportCodeDestVancouverTest1() {
    ...
    assertEquals("YVR", newAirport.getDestAirportCode(), 
        "Expected airport code is : YVR");
  }
  ...
  public void AirportCodeDestVancouverTest3() {
    ...
    System.out.println("destination airport code is " + newAirport.getDestAirportCode());
    assertEquals("Not Found", newAirport.getDestAirportCode(), 
        "Expected airport code is : Not Found");
  }
  ...
  public void AirportCodeDestVancouverTest4() {
    ...
    assertEquals(true, newAirport.isValidDestAirport(), 
        "Expected result is : true");
  }
  ...
  public void AirportCodeDestVancouverTest5() {
    ...
    System.out.println("destination airport code is " + newAirport.getDestAirportCode());
    System.out.println("is destination airport valid? " + newAirport.isValidDestAirport());
    assertEquals(false, newAirport.isValidDestAirport(), 
        "Expected result is : false");
  }
