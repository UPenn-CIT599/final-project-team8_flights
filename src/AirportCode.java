...
public class AirportCode {
  ...
  /**
   * @return the validDeptAirports boolean - set to true if airport code found for dept
   *         city
   */
  ...
  /**
   * @return the validDeptAirports boolean - set to true if airport code found for dest
   *         city
   */
